...
<div class="section2">
    <div class="card mb-3 ">
        <div class="row g-0">
          <div class="col-md-4">
              <img src="img/image.png" class="card-img-top img-fluid " alt="kucing di suntik">
          </div>
          <div class="col-md-8">
            <div class="card-body">
              <h6>Senin, 15 April • 09:30 WIB</h6>
              <h3 class="card-title">Protect-a-Pet Campaign</h3>
              <p class="card-text">
    ...
    <div class="row mb-3">
      <div class="col-md-6">
        <div class="card">
          <div class="row g-0">
            <div class="col-md-4">
              <img src="img/1.png" class="img-fluid card-img3" alt="...">
            </div>
            <div class="col-md-8 ">
              <div class="card-body ">
                <h6>Minggu, 16 Juni • 14:00 WIB</h6>
                <h3 class="card-title">Furry Fashion Show</h3>
                <p class="card-text">
      ...
      <div class="col-md-6">
        <div class="card">
          <div class="row g-0">
            <div class="col-md-4">
              <img src="img/2.png" class="img-fluid card-img3" alt="...">
            </div>
            <div class="col-md-8 ">
              <div class="card-body">
                <h6>Sabtu, 22 Juni • 13:30 WIB</h6>
                <h3 class="card-title">Meow Meetup</h3>
                <p class="card-text">
    ...
    <div class="row mb-3">
      <div class="col-md-6">
        <div class="card">
          <div class="row g-0">
            <div class="col-md-4">
              <img src="img/3.png" class="img-fluid card-img3" alt="...">
            </div>
            <div class="col-md-8">
              <div class="card-body">
                <h6>Minggu, 30 Juni • 09:00 WIB</h6>
                <h3 class="card-title">Doggy Day Out</h3>
                <p class="card-text">
      ...
      <div class="col-md-6">
        <div class="card">
          <div class="row g-0">
            <div class="col-md-4">
              <img src="img/4.png" class="img-fluid card-img3" alt="...">
            </div>
            <div class="col-md-8">
              <div class="card-body">
                <h6>Jumat, 5 Juli • 07:00 WIB</h6>
                <h3 class="card-title">Fur-tastic Fun Run</h3>
                <p class="card-text">
    ...
    <div class="row mb-3">
      <div class="col-md-6">
        <div class="card">
          <div class="row g-0">
            <div class="col-md-4">
              <img src="img/5.png" class="img-fluid card-img3" alt="...">
            </div>
            <div class="col-md-8">
              <div class="card-body">
                <h6>Senin, 7 Juli • 08:00 WIB</h6>
                <h3 class="card-title">Paw-lentine's Day Celebration</h3>
                <p class="card-text">
      ...
      <div class="col-md-6">
        <div class="card">
          <div class="row g-0">
            <div class="col-md-4">
              <img src="img/6.png" class="img-fluid card-img3" alt="...">
            </div>
            <div class="col-md-8">
              <div class="card-body">
                <h6>Sabtu, 14 Juli • 11:00 WIB</h6>
                <h3 class="card-title">Pet Health Check</h3>
                <p class="card-text">
