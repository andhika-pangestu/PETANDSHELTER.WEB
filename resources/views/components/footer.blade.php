          ...
          <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
            ...
            <section class="mb-4">
                ...
                data-mdb-ripple-init
                  class="btn text-white btn-floating m-1 bg-success-700"
                  href="#!"
                  role="button"><i class="fa-brands fa-whatsapp fa-xl"></i>
                </a>
                ...
                href="#!"
                role="button" ><i class="fa-brands fa-instagram fa-xl"></i>
                </a>
          
                <!-- Email -->
                <a
                  data-mdb-ripple-init
                  class="btn text-white btn-floating m-1 bg-accent-700"
                  href="#!"
                  role="button"><i class="fa-regular fa-envelope fa-xl"></i>
                </a>
              </section>
