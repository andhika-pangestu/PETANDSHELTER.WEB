                    ...
                    <div class="justify-content-start">
                        <div class="d-flex p-5">
                            <div style="width: 300px; overflow: hidden;">
                                <div id="carouselId{{ $rescue->id }}" class="carousel slide" data-bs-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="{{ asset('uploads/' . $rescue->fotoHewan) }}" class="d-block w-100">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ asset('uploads/' . $rescue->fotoLokasi) }}" class="d-block w-100">
                                        </div>
                                    </div>
                            ...
                            <div class="ms-5 ">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <p class="mb-0">
                                        ...
                                        <span class="{{ $rescue->status == 'pending' ? 'bg-danger' : ($rescue->status == 'assigned' ? 'bg-warning' : 'bg-accent') }} rounded px-2 py-1">
                                            {{ $rescue->status }}
                                        </span>
                                    </p>
                                </div>
