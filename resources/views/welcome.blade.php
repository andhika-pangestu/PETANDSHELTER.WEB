        ...
        <div class="container col-xxl-8 px-4 py-5">
            <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                ...
                <div class="col-12 col-lg-8"> <!-- Kolom yang berisi teks -->
                    ...
                    <p class="fst-normal">Temukan sahabat sejati Anda dan berikan mereka kehidupan penuh kasih dengan
            ...
            <div class="container">
                <div class="row justify-content-md-center">
                    <div class="col-12 col-md-10 col-lg-8 col-xl-7">
                        <h3 class="fs-6 mb-2 text-secondary text-center text-uppercase">Apa saja yang kita kerjakan?
                        </h3>
                        <h2 class="fs-3 mb-5 text-center">Kami juga menawarkan layanan yang kompeten dan berkualitas.
                        </h2>
                        ...
                        <div
                            ...
                            <div class="card-body text-center p-4 p-xxl-5">
                                ...
                                <a href="{{ route('donations.create') }}"
                                    class="fw-bold text-decoration-none link-primary p-6">
                                    Cari tahu
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                                        <path fill-rule="evenodd"
                ...
                <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                    <div class="col-12 col-lg-8">
                        <div class="col-12 col-md-10 col-lg-8 col-xl-10">
                            <h3 class="fs-6 mb-2 text-secondary fw-bold text-uppercase">Apa saja yang kita kerjakan?
                            </h3>
